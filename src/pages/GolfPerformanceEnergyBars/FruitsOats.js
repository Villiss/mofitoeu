...
const FruitsOats = () => {
  ...
  const rows = [
    createData(t('general_carbohydrates'), '50.9g'),
    createData(t('general_sugar'), '32.1g'),
    createData(t('general_protein'), '4.8g'),
    createData(t('general_fibre'), '3.7g'),
    createData(t('general_fats'), '18.1g'),
  ...
  return (
    <Box textAlign={'center'} 
        ...
        <Paper elevation={1} sx={{ my: 1, p: 5 }}>
          <Typography sx={{ typography: { lg: 'h3', md: 'h4', sm: 'h5', xs: 'h6' }}}>{t('fruit_oats_title')}</Typography>
          <Paper elevation={1} sx={{ my: 1, p: 5 }}>
            ...
            <Typography sx={{my: 1}} variant='body1'>{t('fruit_oats_ingredients')}</Typography>
